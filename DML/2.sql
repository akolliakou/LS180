...
-- The second device should have 5 parts. The part numbers may be any 
-- number between 1 and 10000. There should also be 3 parts that don't 
-- belong to any device yet.
